package com.gluonapplicationDesktopMultipleViews.actions;
...
public class MenuActions {
    ...
    private void about() {
        ...
        alert.setTitle("DigitalDoc");
        alert.setHeaderText("About DigiDoc Desktop");
        alert.setGraphic(new ImageView(new Image(MenuActions.class.getResource("/icon.png").toExternalForm(), 48, 48, true, true)));
        alert.setContentText("This is Digital Document Desktop Application");
        alert.showAndWait();
    }
